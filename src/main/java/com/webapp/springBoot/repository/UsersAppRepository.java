...
public interface UsersAppRepository extends JpaRepository<UsersApp, Long>{
    List<UsersApp> findByNameContainingIgnoreCase(String name);
    List<UsersApp> getUsersByAgeBetween(int ageOne, int ageTwo);
    List<UsersApp> findByNameContainingIgnoreCaseAndSurnameContainingIgnoreCase(String name, String surname);
